...
{
    // logging: http://localhost:8000/students/create
    /**
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'student_image'=> 'image| mimes:jpg,png, jpeg,gif, svg| max:2048| dimentions:min_width=100, min_height=100, max_width=1000, max_height=1000'
        ]);
